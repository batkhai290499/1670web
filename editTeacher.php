  ...
  <div class="limiter">
    <div class="container-table100">
      <div class="wrap-table100">
        <div class="table100">
        <h2>EDIT TEACHER</h2>
                    <form action="functionEditAccount.php" method="post">
                    ...
                    if(isset($_POST["submit"]))
                      {
                        ...
                        if ($user ==""||$password == ""|| $roleID == ""||  $full_name == "" || $Description == "") 
                          ...
                          {
                            $sql = "UPDATE account SET username='$user',password='$password',roleID='$roleID',aName='$full_name', Description='$Description' WHERE accountID=" . $id;
